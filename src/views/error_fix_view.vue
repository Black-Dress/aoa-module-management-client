              ...
              <el-row>
                <el-col v-for="(o, i) in this.selected_tags.length" :key="o" class="c">
                  <el-card @click="click_tag(i)">
                    ...
                    x: {{ this.selected_tags[i].position ? this.selected_tags[i].position.x : "null" }}, y:
                    {{ this.selected_tags[i].position ? this.selected_tags[i].position.y : "null" }}, z:
            ...
            <el-col :span="10" class="a">
              <el-row>
                <el-col :span="24" class="d">
                  <el-button type="primary" style="width: 100px; height: 100px; border-radius: 50px" @click="start"> start </el-button>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24" class="d">
...
export default {
  ...
  methods: {
     ...
     */
    start() {
      if (this.$mqttx.client === undefined || this.$mqttx.client.connected === false) this.$mqttx.connect(this.cur_url.value, this.s, this.f);
